...
|---|---|---|---|
| GNU 13 (referentie) | 13.3.0 / WSL2-Ubuntu x86-64 | **geslaagd** (serieel/OpenMP/strict/MPI-2rank/runtime) | schone strict-bouw 1453/516 groen; CTest 44/47/48/52 per config; installatieproef + quick_test-regressie groen |
| GNU 15 (nieuwere GNU) | 15.2.0 / WSL2-Ubuntu x86-64 | **geslaagd** (configure + telling 44; volledige suite periodiek) | `ctest -N` 44; volledige groen-meting periodiek vóór release |
...
| netCDF-Fortran / MPI (OpenMPI, GNU-wrapper) | systeemlibs | **geslaagd** waar getest (netCDF 47, MPI 47, MPI+netCDF 52) | CTest-tellingen; passende MPI/netCDF-modules per compiler vereist (geen `.mod`-hergebruik zonder compatibiliteitsbewijs) |
...
44 voor standaard/OpenMP/TIMG(/OpenMP)/MATL4/METIS/FFRO/COH/ESMF/ADCIRC/LTO/
native/runtime/debug-invariants/legacy-I/O/GNU15/strict/debug; 47 voor
netCDF/MATL4+netCDF/MPI/JAC/TIMG+MPI/MATL4+MPI/FFRO+MPI; 48 METIS+MPI; 52
