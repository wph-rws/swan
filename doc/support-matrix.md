...
|---|---|---|---|
| GNU 13 (referentie) | 13.3.0 / WSL2-Ubuntu x86-64 | **geslaagd** (serieel/OpenMP/strict/MPI-2rank/runtime) | schone strict-bouw groen (1361/504 op 7-9; **1360/503** herhaald op "Isoleer de tests en sluit de geheugenlevensduur af", 8-9); CTest 58/61/62/63/67 per config; installatieproef + quick_test-regressie groen |
