...
|---|---|---|---|
| GNU 13 (referentie) | 13.3.0 / WSL2-Ubuntu x86-64 | **geslaagd** (serieel/OpenMP/strict/MPI-2rank/runtime) | schone strict-bouw groen (1361/504 op 7-9; 1360/503 op "Isoleer de tests en sluit de geheugenlevensduur af", 8-9; 1358/502 na het `RI`-herstel; 1324/488 na de fysicabenoeming, 10-9; **1317 tegen budget 1318** na argumentbundeling A-D, 11-9); CTest 59/62/63/64/68 per config (elke config +1 door `source_terms_st6`); installatieproef + quick_test-regressie groen |
