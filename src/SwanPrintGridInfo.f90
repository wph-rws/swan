...
!   Source text
    ...
    write(PRINTF,"(// ' The unstructured grid contains ',a,' generated by ',a// ' Number of vertices = ',i7// ' Number of cells = ', i7/ ' Number of internal cells = ', i7/ ' Number of boundary cells = ',i7// ' Number of faces = ',i7/ ' Number of internal faces = ',i7/ ' Number of boundary faces = ',i7//)") trim(helptxt(1)), trim(helptxt(2)), nverts, ncells, &
    ...
    write(PRINTF,"(' The minimum gridsize =',f12.5)") mingsiz
    write(PRINTF,"(' The maximum gridsize =',f12.5)") maxgsiz
